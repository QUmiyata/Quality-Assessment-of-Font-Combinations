...
def calculate_trainfeature_border(c, device, percentile=0.9):
    train_features_load_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/DeepSVDD/result/features/train/{option}/tfepoch{tfepoch}/train_features_epoch{mlpepoch}.pkl'
