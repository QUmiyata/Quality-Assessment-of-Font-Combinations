...
if (option == '_nofont1kind_arranged'):
    test_data_path = f"/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/dataset/csv/{mode}/{mode}_no_font1kind_arranged_sorted.csv"
    test_random_data_path = f"/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/dataset/csv/{mode}/{mode}_no_font1kind_random_arranged_sorted.csv"
# elif (option == '_original'):
#     test_data_path = "/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/dataset/csv/train/old/train_fonts_no_0_sorted.csv"
#     test_random_data_path = "/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/dataset/csv/train/old/train_fonts_random_no_0_range±3.csv"
#     # test_data_path = "/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/dataset/csv/test/old/test_fonts_no_0_sorted.csv"
#     # test_random_data_path = "/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/dataset/csv/test/old/test_fonts_random_no_0_range±3.csv"
batch_size = 128
enc_layers = 2
disc_layers = 2
d_input = 128
...
# モデルの準備
# model.load_state_dict(torch.load(f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/Transformer/result/A-Zstack/models/AEepoch400/model_TF_ValLossMin_epoch10000_nofont1kind_arranged.pth'))
model.load_state_dict(torch.load(f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/Transformer/result/A-Zstack/models/AEepoch{autoen_ep}/per10epoch/model_TF_epoch{num_epochs}_nofont1kind_arranged.pth'))
...
with torch.no_grad():
    for font_list, len_list, id_list, label_list in test_dataloader.yield_batched_data():
        ...
        for font in font_list:
            ...
            # image_font_list.append(latent_dict_loaded[font.item()].tolist())
        ...
        # with open(f'/home/miyatamoe/ドキュメント/研究（支部大会2024）/SIBU_font_image/results/texts/Autoencoder_epoch{autoen_ep}/test/test_match_±3_epoch{num_epochs}.txt', 'a') as match_file, \
        #      open(f'/home/miyatamoe/ドキュメント/研究（支部大会2024）/SIBU_font_image/results/texts/Autoencoder_epoch{autoen_ep}/test/test_mismatch_±3_epoch{num_epochs}.txt', 'a') as mismatch_file:
    ...
    createPCA_fromClstokens(test_predicted_epoch, test_label_list_epoch, test_cls_tokens_epoch, num_epochs, epoch=0, mode=mode, isValLossMin=False)
    ...
    # 保存するファイルパス
    save_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/Transformer/result/A-Zstack/cls_tokens/AEepoch{autoen_ep}/{mode}/clstoken_with_ids_tfepoch{num_epochs}{option}.pth'
    # save_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/Transformer/result/A-Zstack/cls_tokens/AEepoch{autoen_ep}/{mode}/clstoken_with_ids_tf_vallossminepoch10000{option}.pth'
    # 辞書を保存
