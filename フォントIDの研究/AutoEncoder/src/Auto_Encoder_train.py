...
def get_args():
    ...
    parser.add_argument('--img_folder', type=str, default='/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/images/original_crello', help='image folder path')
...
if __name__ == '__main__':
    ...
    im_list = glob.glob(f'{args.img_folder}/**/*.png', recursive=True)
