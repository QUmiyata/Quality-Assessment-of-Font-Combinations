...
def plot_LossCurve(epoch, loss_epochs):
    ...
    plt.grid(True)
    plt.tight_layout()
    result_image_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Loss_Curve/{option}/train_LossCurve_epoch{epoch+1}.png'
...
def plot_Features_train(epoch, features_epoch, c):
    ...
    tra_feature_PCA = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/train/{option}/PCA/train_Feature_PCA_epoch{epoch+1}.png'
    ...
    tra_feature_tSNE = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/train/{option}/tSNE/train_Feature_tSNE_epoch{epoch+1}.png'
...
def plot_Features_test(test_features, test_font_list_all, label_list_all, n_epochs, c):
    ...
    tes_feature_PCA = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/PCA/test_Feature_PCA_epoch{n_epochs}.png'
    ...
    test_feature_PCA_plusNumber = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/PCA/test_Feature_PCA_epoch{n_epochs}_plusNumber.png'
    ...
    test_feature_tSNE = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/tSNE/test_Feature_tSNE_epoch{n_epochs}.png'
    ...
    test_feature_tSNE_plusNumber = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/tSNE/test_Feature_tSNE_epoch{n_epochs}_plusNumber.png'
    ...
    # フォントリストをテキストファイルに出力
    with open(f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/text/test_Feature_tSNE_epoch{n_epochs}_plusNumber_font_info.txt', 'w') as f:
...
def create_fontlist_txt_MSE(test_scores, n_epochs):
    ...
    csv_file_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/test/for_text/{option}/test_fonts_{option}_all.csv'  # 実際のCSVファイルのパスを指定
    idx_to_font = {}
    ...
    output_txt_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/text/test_scores_epoch{n_epochs}.txt'
    ...
    # Prepare the output path for the txt file
    output_csv_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/test/scores/{option}/test_scores_and_fontlist_epoch{n_epochs}.csv'
    # Write the sorted results to the txt file
    ...
    output_KDE_csv_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/test/scores/{option}/KDE/test_scores_and_label_epoch{n_epochs}_KDE.csv'
    # Write the sorted results to the txt file
...
def plot_before_train_cls_tokens(before_train_cls_token, c):
    # 特徴空間可視化
    before_train_cls_token.append(c.tolist())
    data = np.array(before_train_cls_token)  # numpy配列に変換
    ...
    plt.scatter(reduced_data[:, 0], reduced_data[:, 1], c=colors, s=2)
    plt.title("2D Visualization of 512D Vectors (PCA)  Train")
    tra_feature_PCA = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/train/{option}/before_train_cls_tokens_PCA.png'
    plt.savefig(tra_feature_PCA)
    plt.close()
    ...
    plt.scatter(reduced_data[:, 0], reduced_data[:, 1], c=colors, s=2)
    plt.title("2D Visualization of 512D Vectors (t-SNE) Train")
    tra_feature_tSNE = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/train/{option}/before_train_cls_tokens_tSNE.png'
    plt.savefig(tra_feature_tSNE)
    plt.close()
...
def plot_before_test_cls_tokens(before_train_cls_token, label_list_all, c):
    ...
    plt.title("2D Visualization of 512D Vectors (PCA)  Test")
    tes_feature_PCA = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/before_test_cls_tokens_PCA_noC.png'
    plt.savefig(tes_feature_PCA) 
    plt.close()
    ...
    plt.scatter(reduced_data[:, 0], reduced_data[:, 1], c=colors, s=sizes)
    plt.title("2D Visualization of 512D Vectors (t-SNE) Test")
    test_feature_tSNE = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/before_test_cls_tokens_tSNE_noC.png'
    plt.savefig(test_feature_tSNE)
    plt.close()
...
def create_histogram_per_scores():
    n_epochs = 130 #実行時に変更
    file_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/test/scores/{option}/test_scores_and_fontlist_epoch{n_epochs}.csv'
...
def plot_Features_test_and_train(test_features, test_font_list_all, label_list_all, n_epochs, c):
    ...
    # 保存したファイルパス
    train_features_load_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/features/train//{option}/train_features_epoch{n_epochs}.pkl'
    # ピクルファイルを読み込む
    ...
    tes_feature_PCA = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/PCA/test_and_train_Feature_PCA_epoch{n_epochs}.png'
    plt.savefig(tes_feature_PCA) 
    plt.close()
    ...
    test_feature_tSNE = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Features/test/{option}/tSNE/test_and_train_Feature_tSNE_epoch{n_epochs}.png'
    plt.savefig(test_feature_tSNE)
    plt.close()