...
# 1. CSVファイルを読み込む
path = f"/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/test/scores/{option}/test_scores_and_fontlist_epoch{num_epoch}.csv"

# 2. 画像フォルダのパス
image_folder = "/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォント画像の研究/AutoEncoder/久保田さん/font_crello_AtoZ_grayscale/"  # 画像ファイルが格納されているフォルダ

# 3. 出力フォルダ
output_folder = f"/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Combinations_from_score/{option}/epoch{num_epoch}/score_fontlist"
os.makedirs(output_folder, exist_ok=True)
