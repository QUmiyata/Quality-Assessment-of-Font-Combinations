...
def create_Autoencoder_plot(latent, indices_to_plot_images, indices_to_plot_labels, index, score):
    ...
    # 画像保存
    save_path = f"/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/images/Combinations_from_score/nofont1kind_arranged/epoch{num_epoch}/Autoencoder_plot/{score}_{index}.png"  # 保存先のパス
...
# 1. CSVファイルを読み込む
path = f"/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/test/scores/nofont1kind_arranged/test_scores_and_fontlist_epoch{num_epoch}.csv"
