...
@click.argument('xp_path', type=click.Path(exists=True), default='/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/log/TF_and_MLP/nofont1kind_arranged')
# @click.argument('xp_path', type=click.Path(exists=True), default='/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/DeepSVDD/log')
@click.argument('data_path', type=click.Path(exists=True), default='/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/data/TF_and_MLP')
...
@click.option('--load_model', type=click.Path(exists=True), default='/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/models/original/nofont1kind_arranged/model_MLP_300.tar',
