...
class DeepSVDD(object):
    ...
    def train(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
              ...
              n_jobs_dataloader: int = 0, deep_SVDD=None, cfg=None):
        ...
        # Get the model
        self.net = self.trainer.train(dataset, self.net, deep_SVDD=deep_SVDD, cfg=cfg)
    ...
    def save_model(self, export_model, save_ae=False, c=None):
