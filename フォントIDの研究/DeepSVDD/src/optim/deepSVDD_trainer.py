...
class DeepSVDDTrainer(BaseTrainer):
    ...
    def train(self, dataset: BaseADDataset, net: BaseNet, deep_SVDD, cfg):
        ...
        # num_epochs = 200
        # 保存したファイルから辞書を読み込む
        clstoken_dict_load_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/Transformer/result/cls_tokens/train/clstoken_with_ids_tf_vallossminepoch10000_nofont1kind_arranged.pth'
        ...
        if (dataset_name == 'crello'):
            train_data_path = '/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/train/train_no_font1kind_arranged_sorted.csv'
            train_random_data_path = '/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/train/train_fonts_null.csv'
        ...
        for epoch in range(self.n_epochs):
            ...
            if (dataset_name == 'crello'):
                ...
                train_features_save_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/features/train/{option}/train_features_epoch{epoch+1}.pkl'
                with open(train_features_save_path, 'wb') as f:
                    pickle.dump(features_epoch, f)


                # # 1epochごとにネットワークの保存
                # net_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/models/pth/net_MLP_epoch{epoch+1}.pth'
                # torch.save(net.state_dict(), net_path)

                # Save model
                deep_SVDD.save_model(export_model=f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/DeepSVDD/result/models/original/{option}' + f'/model_MLP_{epoch+1}.tar', c=self.c.cpu().data.numpy().tolist())
    ...
    def test(self, dataset: BaseADDataset, net: BaseNet):
        ...
        if (dataset_name == 'crello'):
            test_data_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/{val_or_tes}/{val_or_tes}_no_font1kind_arranged_sorted.csv'
            test_random_data_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/dataset/csv/{val_or_tes}/{val_or_tes}_no_font1kind_random_arranged_sorted.csv'
        ...
        with torch.no_grad():
            if (dataset_name == 'crello'):
                ...
                num_epochs = 200
                # 保存したファイルから辞書を読み込む
                clstoken_dict_load_path = f'/home/miyatamoe/ドキュメント/研究/1class_TF_and_NN/フォントIDの研究/Transformer/result/cls_tokens/{val_or_tes}/clstoken_with_ids_tf_vallossminepoch10000_nofont1kind_arranged.pth'
                clstoken_dict_loaded = torch.load(clstoken_dict_load_path)
